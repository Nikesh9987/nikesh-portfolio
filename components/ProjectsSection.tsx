...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "A full-stack Windows log analysis and forensic investigation tool.",
    longDesc:
      "A full stack Windows log analysis and forensic investigation tool. Upload log files, search and filter entries, detect suspicious activity, and export results - all from a clean web interface.",
    category: "Full Stack",
    color: "#00e5ff",
    gradient: "linear-gradient(135deg, #001a2e 0%, #003655 50%, #001520 100%)",
    tech: ["Python", "Node Js", "MySQL", "JWT", "Docker"],
    github: "https://github.com/Nikesh9987/Log-analysis-extraction-Forensic-tools",
    demo: "#",
    status: "live",
    featured: true,
  },
  {
    id: 2,
    title: "Browser Forensics Tool",
    description: "This tool is intended exclusively for lawful digital forensic investigations conducted by authorized personnel.",
    longDesc:
      "A production-grade Windows desktop application for extracting, decrypting, and analysing browser artefacts from **Google Chrome** and **Microsoft Edge**. Produces structured CSV/JSON exports and a professional HTML forensic report.",
    category: "Full Stack",
    color: "#f89820",
    gradient: "linear-gradient(135deg, #1a0e00 0%, #3d2200 50%, #1a0e00 100%)",
    tech: ["Python", "Node Js", "React", "MongoDB", "REST API"],
    github: "https://github.com/Nikesh9987/log-forensic-tool",
    demo: "#",
    status: "demo",
  },
  {
